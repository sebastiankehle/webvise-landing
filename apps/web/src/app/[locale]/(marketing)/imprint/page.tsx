...
export default async function ImprintPage() {
	...
	return (
		<article className="mx-auto max-w-[1320px] px-6 py-32 md:py-44">
			...
			<div className="mt-16 max-w-2xl space-y-12 text-muted-foreground leading-[1.5] [&_h2]:mb-4 [&_h2]:font-display [&_h2]:text-foreground [&_h2]:text-[16px] [&_h2]:leading-[21px] [&_h2]:tracking-[-0.011em]">
